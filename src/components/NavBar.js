...
const NavBar = ({ userDevice }) => {
  ...
  let mobileNavLayout = (
    <>
      <div
        ...
        } transition-width transition-slowest ease absolute flex h-full  items-center justify-center bg-white duration-1000`}
      >
        <div
          className={`${
  ...
  let laptopNavLayout = (
    <>
      <div
        className={`${
          userDevice === "laptop" || userDevice === "tablet" ? "" : "hidden"
